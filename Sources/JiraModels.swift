...
struct JiraConfig: Codable, Sendable {
    ...
    var pollingStartMinute: Int = 0
    var pollingEndHour: Int = 18
    var pollingEndMinute: Int = 0
    ...
    init(from decoder: Decoder) throws {
        ...
        pollingStartMinute = try c.decodeIfPresent(Int.self, forKey: .pollingStartMinute) ?? 0
        pollingEndHour = try c.decodeIfPresent(Int.self, forKey: .pollingEndHour) ?? 18
        pollingEndMinute = try c.decodeIfPresent(Int.self, forKey: .pollingEndMinute) ?? 0
